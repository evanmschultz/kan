...
func (k keyMap) ShortHelp() []key.Binding {
	return []key.Binding{
		k.addTask, k.addSubtask, k.taskInfo, k.editTask, k.focusSubtree, k.commandPalette, k.undo, k.activityLog, k.quit,
	}
}
...
func (k keyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		{k.addTask, k.addSubtask, k.taskInfo, k.editTask, k.newProject, k.editProject, k.commandPalette, k.quickActions, k.search, k.projects, k.toggleArchived, k.focusSubtree, k.clearFocus, k.toggleHelp, k.reload, k.quit},
